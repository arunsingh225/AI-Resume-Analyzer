...
SECTION_ALIASES = {
    ...
    "certifications":["certifications","certification","certificates","certificate","professional certifications","credentials","licensed","accreditations","courses completed","licences","licensure"],
    "achievements": ["achievements","achievement","accomplishments","awards","recognition","honors","accolades","highlights","competitive programming","extra-curricular","extracurricular","co-curricular","competitions","hackathons"],
